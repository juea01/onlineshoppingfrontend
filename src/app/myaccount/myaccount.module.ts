...
let routing = RouterModule.forChild([
  ...
  children: [
   ...
   {path: "practicetests/:level/:subCategory", component: SubjectsComponent},
   {path: "practicetests/:subCategory", component: SubjectsComponent},
   {path: "practicetests", component: SubjectsComponent},
   {path: "subjectdetail/:id/:level/:subCategory/:isPremium", component: QuestiondetailComponent, canActivate: [AuthKeyCloakGuard],data: {roles: ['PREMIUM', 'ADMIN']}},
